...
# 對應的時速斷點 (km/h):       [ 0,    10,   20,   30,   40,   50,   70,   90,  110,  130,  150 ]
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.25, 1.25, 1.25, 1.55, 1.55, 1.65, 1.75, 1.75, 1.95, 1.95, 1.95],
  LongPersonality.standard:   [1.15, 1.15, 1.15, 1.35, 1.35, 1.45, 1.45, 1.45, 1.55, 1.55, 1.65],
  LongPersonality.aggressive: [0.85, 0.85, 1.05, 1.15, 1.15, 1.25, 1.25, 1.25, 1.35, 1.35, 1.45],
}

# 將上述指定的 km/h 斷點轉換為系統使用的 m/s
FOLLOW_BREAKPOINTS = [v / 3.6 for v in [0, 10, 20, 30, 40, 50, 70, 90, 110, 130, 150]]
