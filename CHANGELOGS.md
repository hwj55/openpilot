dragonpilot 0.11.1  (2026-06-22)  herizon1054 自訂版 請注意安全
=======================
* 追加-豐田盲點資料
* 刪除acm 修改為ocm 超車滑行 當前車距離兩秒以上 車速超過定速+20 放開油門後 會用滑行回到定速
* 追加-dtsc過彎減速功能
* 修改-apm改為根據前車距離切換車距達到提早煞車作用
* 追加-加速度風格控制器有三種油門加速風格
* 追加-htd人工轉彎干預  非自動巡航且車速低於35公里 駕駛正在扭動方向盤時可以暫時解除橫向 當駕駛將方向盤回正 DP會自動接管橫向
* 追加-c3 c3x 底部ui資訊列
* 修改-螢幕亮度最高只40%
* 修改-關閉錄影只保留LOG
