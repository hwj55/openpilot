...
MAX_ACCEL_PROFILES = {
  ...
  "normal":             [2.00, 2.00, 1.99, 1.68, 1.09, .69,  .60, .49, .37, .15],
  "sport":              [2.00, 2.00, 2.00, 1.95, 1.25, .88,  .70, .60, .45, .20],
}
MAX_ACCEL_BREAKPOINTS = [0.,   1.,   6.,   8.,   11.,  16.,  20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  #"eco":                [-1.0,  -1.0,   -1.0,  -.90,  -.90,  -.900, -.900, -1.0, -1.0],
  #"normal":             [-1.1,  -1.1,   -1.1,  -1.1,  -.400, -.500, -.500, -1.1, -1.1],
  #"sport":              [-1.2,  -1.2,   -1.2,  -1.2,  -1.0,  -.600, -.600, -1.2, -1.2],
  "eco":                [-.09,  -.11,  -.11, -.10, -.070, -.070, -.072, -.65, -.65],
  "normal":             [-.09,  -.12,  -.12, -.11, -.071, -.071, -.073, -.70, -.70],
  "sport":              [-.09,  -.13,  -.13, -.12, -.072, -.072, -.074, -.75, -.75],
  "stock":              [-1.2,  -1.2,   -1.2,  -1.2, -1.2,  -1.2,  -1.2,  -1.2, -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,    0.7,    1.2,   5.,   8.,    12.,   14.,   25.,  40.]
