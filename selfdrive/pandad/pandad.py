  ...
  while not do_exit:
    try:
      ...
      if len(panda_serials) == 0:
        # Force the internal panda into DFU bootloader (BOOT0 high) so a blank
        # or unbootable MCU can be recovered over USB.
        cloudlog.info("No panda in normal mode, forcing internal panda into DFU")
        HARDWARE.recover_internal_panda()
        time.sleep(1)
