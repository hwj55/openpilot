...
BORDER_COLORS = {
  UIStatus.DISENGAGED: rl.Color(0x12, 0x28, 0x39, 0x80),  # Blue for disengaged state
  UIStatus.OVERRIDE: rl.Color(0x89, 0x92, 0x8D, 0xFF),  # Gray for override state
  UIStatus.ENGAGED: rl.Color(0x16, 0x7F, 0x40, 0x80),  # Green for engaged state
  UIStatus.ALKA: rl.Color(0x22, 0xa0, 0xdc, 0x80),  # Blue for ALKA state
}
