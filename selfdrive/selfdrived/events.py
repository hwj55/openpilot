...
def comm_issue_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  ...
  return NoEntryAlert(msg, alert_text_1="程序通讯故障")
...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.lateralManeuver: {
    ET.WARNING: longitudinal_maneuver_alert,
    ET.PERMANENT: NormalPermanentAlert("横向操控模式"),
  },
  ...
  EventName.stockLkas: {
    ET.NO_ENTRY: NoEntryAlert("原厂 LKAS: 检测到车道偏离"),
  },
  ...
  EventName.cameraMalfunction: {
    ...
    ET.NO_ENTRY: NoEntryAlert("相机故障: 重新启动设备"),
  },
  # Camera framerate too low
  EventName.cameraFrameRate: {
    ET.PERMANENT: NormalPermanentAlert("相机帧率过低", "重新启动设备"),
    ET.SOFT_DISABLE: soft_disable_alert("相机帧率过低"),
    ET.NO_ENTRY: NoEntryAlert("相机帧率过低: 重新启动设备"),
  },
  ...
  EventName.pedalPressed: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.disengage),
    ET.NO_ENTRY: NoEntryAlert("驾驶踩下油门或刹车",
  ...
  EventName.commIssue: {
    ET.SOFT_DISABLE: soft_disable_alert("程序通讯故障"),
    ET.NO_ENTRY: comm_issue_alert,
  },
  EventName.commIssueAvgFreq: {
    ET.SOFT_DISABLE: soft_disable_alert("程序间通讯频率过低"),
    ET.NO_ENTRY: NoEntryAlert("程序间通讯频率过低"),
  },

  EventName.selfdrivedLagging: {
    ET.SOFT_DISABLE: soft_disable_alert("系统延迟"),
    ET.NO_ENTRY: NoEntryAlert("Selfdrive 进程延迟: 重新启动设备"),
  },
  ...
  EventName.espActive: {
    ET.SOFT_DISABLE: soft_disable_alert("电子稳定系统已运行"),
    ET.NO_ENTRY: NoEntryAlert("电子稳定系统已运行"),
  },
  ...
  EventName.usbError: {
    ET.SOFT_DISABLE: soft_disable_alert("USB 错误: 重新启动设备"),
    ET.PERMANENT: NormalPermanentAlert("USB 错误: 重新启动设备"),
    ET.NO_ENTRY: NoEntryAlert("USB 错误: 重新启动设备"),
  },
